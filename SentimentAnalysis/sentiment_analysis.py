...
def emotion_detector(text_to_analyze):
    """
    Envía una petición al servicio Watson NLP para analizar emociones en el texto
    y devuelve las puntuaciones de cada emoción junto con la emoción dominante.
    """
    ...
    # Extraer las puntuaciones individuales de cada emoción
    ...
    # Estructurar el diccionario para encontrar la emoción dominante
    emotion_scores = {
        'anger': anger_score,
